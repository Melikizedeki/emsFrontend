    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-6 mb-6">
        <button
          ...
          className={`w-full md:w-64 py-4 text-xl font-semibold text-white rounded-xl ${insideGeofence ? "bg-green-600 hover:bg-green-700" : "bg-gray-400 cursor-not-allowed"}`}
        >
          Check In
        </button>
        <button
          ...
          disabled={!insideGeofence || loading}
          className={`w-full md:w-64 py-4 text-xl font-semibold text-white rounded-xl ${insideGeofence ? "bg-blue-600 hover:bg-blue-700" : "bg-gray-400 cursor-not-allowed"}`}
        >
          Check Out
        </button>
      </div>
